...
The generate function should contain code that creates the NVD3 modelo.blade.php, sets options
on it, adds data to an SVG element, and invokes the chart modelo.blade.php. The generate function
should return the chart modelo.blade.php.  See examples/lineChart.html for a usage example.
...
nv.models.tooltip = function() {
    ...
    */
    ...
    // By default, the tooltip modelo.blade.php renders a beautiful table inside a DIV.
...
nv.models.boxPlot = function() {
    ...
    var margin = {top: 0, right: 0, bottom: 0, left: 0},
        ...
        getX  = function(d) { return d.label }, // Default data modelo.blade.php selectors.
    ...
    chart._options = Object.create({}, {
        ...
        y: {
            get: function() {
                console.warn('BoxPlot \'y\' chart option is deprecated. Please use modelo.blade.php overrides instead.');
                return {};
            },
            set: function(_) {
                console.warn('BoxPlot \'y\' chart option is deprecated. Please use modelo.blade.php overrides instead.');
...
//TODO: consider deprecating by adding necessary features to multiBar modelo.blade.php
...
nv.models.lineChart = function() {
    ...
    chart._options = Object.create({}, {
        ...
        defaultState:    {get: function(){return defaultState;}, set: function(_){defaultState=_;}},
        noData:    {get: function(){return noData;}, set: function(_){noData=_;}},
        // Focus options, mostly passed onto focus modelo.blade.php.
    ...
    function chart(selection) {
        ...
        selection.each(function(data) {
            ...
            data = d3.layout.stack()
                .order(order)
                .offset(offset)
                .values(function(d) { return d.values })  //TODO: make values customizeable in EVERY modelo.blade.php in this fashion
                .x(getX)
                .y(getY)
                .out(function(d, y0, y) {
                    d.display = {
