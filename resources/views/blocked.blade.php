                        ...
                        <div class="auth-box">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <p class="text-inverse text-center m-b-0"><a target="_blank" href="{{ url('/terminosycondiciones') }}">términos y condiciones </a> de digianuncios.com, para desbloquear su  </p>
                                    <p class="text-inverse text-center m-b-0">cuenta comuníquese con el departamento de desbloqueos para su  </p>
