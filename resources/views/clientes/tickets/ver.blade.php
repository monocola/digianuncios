                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <div class="card-block user-box">
                                ...
                                <div class="media">
                                    <a class="media-left" href="#">
                                        <img class="media-object img-circle m-r-20" src="/avatars/{{Auth::user()->avatar}}" alt="Generic placeholder image">
                                    </a>

                                    <div class="media-body">
                                        <form class="" action="/admin/miticket-respuesta"  method="post" onsubmit="return checkSubmit();">
                                            {{ csrf_field() }}
                                            <div class="">
                                                ...
                                                <div id="btnShow" class="text-right m-t-20"><button type="submit"  class="btn btn-primary waves-effect waves-light">Responder</button></div>
                                                <div style="display: none;" id="btnhidden" class="text-right m-t-20"><button type="submit" disabled  class="btn btn-success waves-effect waves-light">Enviando...</button></div>
                                            </div>
                                        </form>
                                    </div>
                                </div>
